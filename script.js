...
/** Placeholder alur pembelian Premium. Aplikasi ini BELUM terhubung ke
    pemroses pembayaran sungguhan (mis. Google Play Billing / RevenueCat) --
    itu perlu integrasi tambahan di sisi native Android, di luar cakupan
    tiga file web ini (index.html/script.js/style.css), dan tergantung pada
    tool pembungkus APK yang kamu pakai untuk naik ke Play Store.
    Untuk sekarang, tombol "Lihat Paket Premium" menampilkan info kontak
    supaya kamu bisa mengaktifkan Premium secara MANUAL lewat tabel
    bukukas_premium di Supabase (bagian 16) setelah pengguna membayar lewat
    kanal apa pun yang kamu pakai saat ini. Ganti teksnya sesuai kanal
    pembayaran/kontak kamu, atau sambungkan ke alur pembelian sungguhan
    nanti kalau sudah siap. */
async function openPremiumPaywall(){
  await swalFire({
    title: 'Berlangganan Premium',
    html: `<p class="swal-theme-html">Pembelian otomatis lewat Play Store belum tersedia di versi ini. Hubungi kami untuk mengaktifkan Premium secara manual.</p>`,
